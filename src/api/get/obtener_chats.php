<?php
/**
 * API para obtener los chats de un estudiante
 * 
 * Método: GET
 * 
 ...
 * 
 * Ejemplo de URL:
 * servidor:puerto/api/get/obtener_chats.php?numero_cuenta=20241000001
 * 
 * Métodos soportados:
 * GET
 *
...
try {
    ...
    $result = $controller->obtenerChats($_GET['numero_cuenta']);
