   ...
   /**
    ...
    public function seccionListaEstudiantes($seccion_id) {
        $sql = "SELECT 
                ...
                LEFT JOIN HistorialEstudiante he ON he.seccion_id = m.seccion_id AND he.estudiante_id = m.estudiante_id
                WHERE m.seccion_id = ?";
        ...
        if ($result->num_rows === 0) {
            throw new Exception("No se encontraron estudiantes para la sección especificada", 404);
        }
